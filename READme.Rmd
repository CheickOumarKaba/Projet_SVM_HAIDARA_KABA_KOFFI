...
Nous avons construit un démonstrateur en ligne avec R shiny qui vous permettra de vous rendre compte de la facillité d'emploi et des SVM, de visualiser ses performances en jouant sur le choix, des kernels, des hyper-paramètres dans le cadre de la detection de fraude sur les carte de crédits. Ce démonstrateur vous permettra par aillleurs de Comparez les performances du SVM à celle de la régression logistique.  
Pour cela, vous devez au préalable télécharger la base de donnée "newdata.Rdata" qui désigne la base disponible sur Kaggle à laquelle nous avons apporté quelques modifications.  
Cette base est disponible en téléchargement [__***ici***__](https://github.com/CheickOumarKaba/daishi/blob/master/newdata.RData) 
